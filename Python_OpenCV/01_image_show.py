...
path = 'C:/Users/3DOS/Desktop/Python_Tutorial/openCV/'
img = cv.imread(path + 'glass.jpg')     # glass.jpg 파일을 읽어옴 -> cv.imread('파일경로/파일명') 함수 사용

gray = cv.imread(path + 'glass.jpg', cv.IMREAD_GRAYSCALE)     # glass.jpg 파일을 흑백이미지로 읽어옴
...
# 동영상 파일 출력
video = cv.VideoCapture(path + 'Piano.mp4')
