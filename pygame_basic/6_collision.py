...
# 적 캐릭터 만들기
enemy = pygame.image.load("C:/Users/3DOS/Desktop/Python_Tutorial/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size      # 캐릭터 이미지의 크기를 구해옴
enemy_width = enemy_size[0]
enemy_height = enemy_size[1]
# 캐릭터를 배경화면 정중앙에 위치 시킴
...
while running:
    ...
    screen.blit(enemy, (enemy_x_pos, enemy_y_pos))     # 배경 이미지 디스플레이
